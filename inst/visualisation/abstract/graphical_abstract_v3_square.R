# ==============================================================================
# Graphical abstract — final v3 SQUARE version for PCJ
# ==============================================================================
#
...
square_abstract <-
  ...
  plot_layout(
    design = c(
      area(t=2, b=9,  l=1, r=5), # baseline
      area(t=3, b=3,  l=6, r=6), # arrow
      area(t=1, b=2,  l=7, r=16), # hist
      area(t=3, b=10, l=7, r=16)  # main
    )) +
  plot_annotation(
    title = paste(
    ...
    subtitle = paste(
      ...
      "scores\nindistinguishable from typical imagers, whereas a negative",
      "linear relationship\nbetween imagery vividness and alexithymia exists",
      "on the rest of the imagery\ncontinuum, showing that weak, residual",
      "imagery is associated with greater\ndifficulty understanding",
      "one's own emotions."
    ),
    theme = ggplot2::theme(
      plot.title = ggplot2::element_text(
        size = base_size + 2, family = "Montserrat",
...
save_ggplot(
  square_abstract,
  path = here::here("man/figures/graphical_abstract_v3_square.png"),
  width = 1000,
  height = 1000,
  dpi = 600,
  units = "px",
