...
presented in the article "*Evidence of a Non-linear Relationship Between Visual
Imagery and Alexithymia: Complete Aphantasics Report Typical Meta-Emotional
Functioning*". You can read the preprint <a href="https://doi.org/10.31234/osf.io/es425_v1" target="_blank">here</a>. This repository is archived with a permanent DOI on the Open
...
Beyond the article itself, this project's full analysis is documented as an
...
- [**Model comparison**](https://m-delem.github.io/aphantasiaEmotions/articles/model-comparison.html) — how a naive threshold, a categorical grouping, and several continuous models were compared, including a direct comparison against @kvammeWhenWeakImagery2025's own published approach.
...
> Delem, M. (2026). "Supplementary materials for 'Evidence of a Non-linear Relationship Between Visual Imagery and Alexithymia'." https://doi.org/10.17605/OSF.IO/B837S.
