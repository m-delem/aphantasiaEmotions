...
- [`check_knot_still_matches()`](https://m-delem.github.io/aphantasiaEmotions/reference/check_knot_still_matches.md)
  ...
  MARS estimate
- [`check_scales_reliability()`](https://m-delem.github.io/aphantasiaEmotions/reference/check_scales_reliability.md)
  : Check the internal reliability of the VVIQ, TAS-20 and its
  sub-scales
